...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item {{($url=='dashboard' || $url==null)?'active':''}}">
                <a class="nav-link" href="{{url('admin/dashboard')}}">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Dashboard</span>
                </a>
            </li>
            <li class="nav-item {{$url=='faculty'?'active':''}}">
                <a class="nav-link" href="{{url('admin/faculty')}}">
                    <i class="fas fa-fw fa-building"></i>
                    <span>Faculty</span>
                </a>
            </li>
            <li class="nav-item {{$url=='period'?'active':''}}">
                <a class="nav-link" href="{{url('admin/period')}}">
                    <i class="far fa-fw fa-calendar-alt"></i>
                    <span>Period</span>
                </a>
            </li>
            <li class="nav-item {{$url=='participant'?'active':''}}">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="{{asset('admin_template/image/undraw_profile.svg')}}">
                            </a>
    ...
    @yield('script')
    <script src="{{asset('admin_template/js/datatables-demo.js')}}"></script>
</body>
